                        ...
                        <div class="col-md-6 col-ms-12">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <p>Alamat</p>
                                    <div class="col-md-12">
                                        <textarea name="alamat_pasien" id="alamat_pasien" cols="50" rows="5" class="form-control"
                                            value="{{ $pasien->alamat_pasien }}">{{ $pasien->alamat_pasien }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-ms-12">
                            <div class="row">
                                <div class="form-group">
                                    <p>No Telpon</p>
                                    <div class="col-md-12">
                                        <input type="number" name="no_telp_pasien" value="{{ $pasien->no_telp_pasien }}"
                            ...
                            <div class="row mt-2">
                                <div class="form-group">
                                    <p>Rumah Sakit</p>
                                    <div class="col-md-12">
                                        <select id="profilrumahsakit_id" name="profilrumahsakit_id" class="form-select"
                                            class="form-control select2">
                                            <option value="{{ $pasien->rumahsakit->nama_rumahsakit }}">Pilih Rumah Sakit
                                            </option>
                                            @foreach ($profilrumahsakit as $item)
                                                <option {{ $pasien->profilrumahsakit_id == $item->id ? 'selected' : '' }}
                                                    value="{{ $item->id }}">{{ $item->nama_rumahsakit }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
